...
?>
<div  style="width:100%">
<h3 id="heading" align="center">Invoice Report</h3>
...
$query = "SELECT * FROM invoices WHERE (date BETWEEN '$sdate' AND '$edate') AND status>0";
...
$sno=$sno+1;
   ...
   echo "<td><a href='print-invoice.php?inv=".$row['id']."' class='btn-sm btn-primary' target='_blank'>Details</a></td>";
